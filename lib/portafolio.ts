...
export const TRADITIONAL_CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    pieces: [
      { url: "/videos/trad-wong-01.mp4", label: "Wong", client: "Bubu The Creator" },
      { url: "/videos/trad-wong-02.mp4", label: "Wong", client: "Bubu The Creator" },
      { url: "/videos/trad-wong-03.mp4", label: "Wong", client: "Bubu The Creator" },
      { url: "/videos/trad-wong-04.mp4", label: "Wong", client: "Bubu The Creator" },
      { url: "/videos/trad-wong-05.mp4", label: "Wong", client: "Bubu The Creator" },
      { url: "/videos/trad-wong-06.mp4", label: "Wong", client: "Bubu The Creator" },
    ],
  },
  {
    n: "05",
    ...
    pieces: [
      { url: "/videos/trad-redondos-01.mp4", label: "Redondos", client: "Bubu The Creator" },
      { url: "/videos/trad-redondos-02.mp4", label: "Redondos", client: "Bubu The Creator" },
      { url: "/videos/trad-redondos-03.mp4", label: "Redondos", client: "Bubu The Creator" },
      { url: "/videos/trad-redondos-04.mp4", label: "Redondos", client: "Bubu The Creator" },
      { url: "/videos/trad-redondos-05.mp4", label: "Redondos", client: "Bubu The Creator" },
      { url: "/videos/trad-redondos-06.mp4", label: "Redondos", client: "Bubu The Creator" },
    ],
  },
];
