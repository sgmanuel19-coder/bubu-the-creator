...
export default function CookieConsentBanner() {
  ...
  return (
    ...
    >
      ...
      >
        Usamos cookies de análisis (Vercel Analytics) y publicidad (Meta Pixel) para
        mejorar la experiencia y medir conversiones.{' '}
        <span style={{ color: 'rgba(248,248,242,0.4)' }}>
          El Pixel de Meta solo se activa si aceptas. Puedes continuar sin cookies de
          marketing.
        </span>
      </p>
