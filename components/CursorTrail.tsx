...
export default function CursorTrail() {
  ...
  useEffect(() => {
    ...
    const spawnParticle = (x: number, y: number) => {
      ...
      const color = isGreen
        ? `rgba(26,128,255,${opacity})`
        : `rgba(77,159,255,${opacity})`;
      const glow1 = isGreen
        ? `rgba(26,128,255,0.9)`
        : `rgba(10,77,170,0.9)`;
      const glow2 = isGreen
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          height: 28,
          borderRadius: "50%",
          border: "1px solid rgba(26,128,255,0.55)",
          boxShadow: "0 0 10px rgba(26,128,255,0.4)",
          willChange: "transform",
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(10,77,170,0.22) 0%, rgba(26,128,255,0.08) 50%, transparent 70%)",
          filter: "blur(10px)",
          willChange: "transform",
