...
import { novedadesGlobales } from "@/lib/taller/boveda-server";
...
export default async function NovedadesPage() {
  ...
  // Guías con fecha de publicación + anuncios manuales (ver boveda-server).
  const novedades = novedadesGlobales();
            ...
            {novedades.map((n, i) => (
              ...
              >
                ...
                <h2 className="mt-2 font-semibold">
                  {n.href && desbloqueado ? (
                    <a href={n.href} className="transition-opacity hover:opacity-80">
                      {n.titulo} →
                    </a>
                  ) : (
                    n.titulo
